...
st.markdown("""
    ...
    /* Chỉnh khoảng cách của toàn bộ khối nội dung */
...
/* Tối ưu vùng thông báo đỏ */
    ...
    /* Triệt tiêu khoảng cách của nội dung bên trong */
    [data-testid="stNotificationContent"] div {
        margin: 0px !important;
        padding: 0px !important;
    }

    /* Ép chữ tiêu đề (###) không được có margin */
    .stAlert h3 {
        color: white !important;
        font-weight: bold !important;
    ...
    /* Ẩn icon để chữ căn giữa đẹp hơn */
